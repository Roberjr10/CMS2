...
<div class="row">
    ...
    <form class="col m12 l6" method="POST" action="<?php echo $_SESSION['home'] ?>admin/personas/editar/<?php echo $id ?>">
        ...
        <div class="row">
            ...
            <p>
                <label for="noticias">
                    <input id="noticias" name="noticias" type="checkbox" <?php echo ($datos->acceso == 1) ? "checked" : "" ?>>
                    <span>Noticias</span>
                </label>
            </p>
            <p>
                <label for="usuarios">
                    <input id="usuarios" name="usuarios" type="checkbox" <?php echo ($datos->acceso == 1) ? "checked" : "" ?>>
                    <span>Usuarios</span>
                </label>
            </p>
            <?php $clase = ($datos->id) ? "" : "hide" ?>
